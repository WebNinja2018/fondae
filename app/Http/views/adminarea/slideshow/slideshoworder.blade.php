...
<script>
	$(function() {
		  $('.submitbuttonSave').click(function()
		  {
			  ...
			  $.ajax({
				type: "POST",
				url: "{{ url('/') }}/adminarea/slideshow/saveorder",
				data: 'item='+h,
...
<form class="form-inline" role="form" name="frm_slideshow_addedit" method="post" action="{{ url('/') }}/adminarea/slideshow/saveorder">
...
<div class="right_side" role="main">
    <div class="center_container">
        <ul class="breadcrumb">
          ...
          <li class="active">Slideshow Order</li>
        </ul>
    </div>
    <div class="panel row">
        ...
        <div class="col-md-6" role="main">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
				  <tr>
                    <th width="23%">Slideshow Title</th>
                  </tr>
                  <tr>
                      <td colspan="2">
                            <div id="sortable">
								...
								<?php $no_row=1; ?>
                                     @foreach($qGetAllSlideshow as $GetAllslideshow)
                                      <div id="image_li_{{$GetAllslideshow->slideshowID}}" class="innerproduct_order_col ui-sortable-handle" >
                                         {{ $GetAllslideshow->slideshowTitle}}
                                      </div>
                                    <?php $no_row++; ?>
									@endforeach
                                 @else
