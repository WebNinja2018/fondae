...
<script>
	$(function() {
		  $('.submitbuttonSave').click(function()
		  {
			  ...
			  $.ajax({
				type: "POST",
				url: "{{ url('/') }}/adminarea/portfolio/saveorder",
				data: 'item='+h,
...
<?php
	...
	$redirects_to=old('redirects_to')?old('redirects_to'): url('/').'/adminarea/portfolio';
	}
?>

<form class="form-inline" role="form" name="frm_portfolio_addedit" method="post" action="{{ url('/') }}/adminarea/portfolio/saveorder">
...
<div class="right_side" role="main">
    <div class="center_container">
        <ul class="breadcrumb">
          ...
          <li class="active">Portfolio Order</li>
        </ul>
    </div>
    <div class="panel row">
        ...
        <div class="col-md-6" role="main">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
				  <tr>
                    <th width="23%">Portfolio Title</th>
                  </tr>
                  <tr>
                      <td colspan="2">
                            <div id="sortable">
								...
								<?php $no_row=1; ?>
                                     @foreach($qGetAllPortfolio as $GetAllportfolio)
                                      <div id="image_li_{{$GetAllportfolio->portfolioID}}" class="innerproduct_order_col ui-sortable-handle" >
                                         {{ $GetAllportfolio->portfolioTitle}}
                                      </div>
                                    <?php $no_row++; ?>
									@endforeach
                                 @else
