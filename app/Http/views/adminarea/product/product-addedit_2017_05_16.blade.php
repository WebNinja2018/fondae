...
if($productID != NULL && $productID >0)
{
	...
	//Only Pakage Module[Start]
	if($prodcutPriceRecordCount > 0 && $CategorytypeID == Config::get('config.packageCategorytypeID','12')){
		$priceID=$qGetProductPriceData[0]->priceID;
		$price=$qGetProductPriceData[0]->price;
		$quantity=$qGetProductPriceData[0]->quantity;
		$sizeID=$qGetProductPriceData[0]->sizeID;
	}
	//Only Pakage Module[End]
...
?>
    ...
    <ol class="breadcrumb">
		...
		@if($CategorytypeID == Config::get('config.packageCategorytypeID','12'))
			<li><a href="{{ url('/') }}/adminarea/product/package">Package Management</a></li>
		@else
        	<li><a href="{{ url('/') }}/adminarea/product">Product Management</a></li>
		@endif
        <li class="active">@if($productID != NULL && $productID >0) Edit @else Add @endif Product </a></li>
    </ol>
    <section class="content-header top_header_content">
    	<div class="nav-tabs-custom">
             ...
             <ul class="nav nav-tabs" role="tablist">
                   ...
                   <?php if($productID != 0  && $CategorytypeID != Config::get('config.packageCategorytypeID','12')){ ?>
                      ...
                      <li><a href="#size_tab" role="tab" data-toggle="tab">Product Options</a></li>
                            ...
                            <div class="box">
                                <div class="property_add">
                                    ...
                                    <div class="box-title with-border">
                                        <h2>@if($productID != NULL && $productID >0) Edit @else Add @endif Product</h2>
                                    </div>
                                    <!-- end box -header -->
                                    <!-- strat box-body area-->
                                                ...
                                                <div class="addunit_forms">
                                                    <div class="box-body">
                                                       <div class="form-group-main">
    														<?php /*?>Product Staff Only This Project[Start]<?php */?>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 col-md-2 col-xs-5 control-label text-left">Product Staff <span class="mandatory_field">*</span></label>
                                                                <div class="col-sm-6 col-md-6 col-xs-9">
                                                                    <?php if($checkedStaffRecordCount>0)
                                                                         {
                                                                             $staffID=$qGetCheckedStaff[0]->staffID;
                                                                            
                                                                         }
                                                                    ?>
                                                                    <select name="staffID" class="form-control" id="staffID">
                                                                        <option selected="selected" value="">==Select Product Staff==</option>
                                                                        @foreach($qGetAllStaff as $GetAllStaff)
                                                                        <option value="{{$GetAllStaff->staffID}}" @if($GetAllStaff->staffID==$staffID)selected="selected"@endif>{{ $GetAllStaff->firstname }} {{ $GetAllStaff->lastname }}</option>
                                                                        @endforeach
                                                                     </select>
                                                                </div>
                                                            </div>
                                                            <?php /*?>Product Staff Only This Project[End]<?php */?>

                                                            <?php /*?>Product Category Only This Project[Start]<?php */?>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 col-md-2 col-xs-5 control-label text-left">Product Category <span class="mandatory_field">*</span></label>
                                                                <div class="col-sm-6 col-md-6 col-xs-9">
                                                                    <?php /*?><?php 
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-2 col-md-2 col-xs-5 control-label">Product Name <span class="mandatory_field">*</span></label>
                                                                <div class="col-sm-6 col-md-6 col-xs-9">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-md-6 col-xs-9">
                                                                    <select name="availabilityStatus" class="form-control" id="availabilityStatus">
                                                                        ...
                                                                        <option value="0" @if($availabilityStatus==0)selected="selected"@endif>In Stock</option>
                                                                        <option value="1" @if($availabilityStatus==1)selected="selected"@endif>Out of Stock</option>
                                                                     </select>
                                                                </div>
                                                            </div>
															...
															{{-- Only Pakage Module[Start] --}}
															@if( $CategorytypeID == Config::get('config.packageCategorytypeID','12'))
																<input type="hidden" class="form-control" name="priceID" maxlength="10" id="priceID" value="{{$priceID}}" title="Price">
																<input type="hidden" class="form-control" name="sizeID" maxlength="10" id="sizeID" value="{{$sizeID}}" title="sizeID">
																<div class="form-group">
                                                                    <label class="col-sm-2 col-md-2 col-xs-5 control-label">Avalible Quntity <span class="mandatory_field">*</span></label>
                                                                    <div class="col-sm-6 col-md-6 col-xs-9">
                                                                        <input type="text" class="form-control" name="quantity" maxlength="10" id="quantity" placeholder="Avalible Quntity" value="{{$quantity}}" title="Quantity">
                                                                    </div>
                                                                </div>

																<div class="form-group">
                                                                    <label class="col-sm-2 col-md-2 col-xs-5 control-label">Price <span class="mandatory_field">*</span></label>
                                                                    <div class="col-sm-6 col-md-6 col-xs-9">
                                                                        <input type="text" class="form-control" name="price" maxlength="10" id="price" placeholder="Price" value="{{$price}}" title="Price">
                                                                    </div>
                                                                </div>
															@else
															{{-- Only Pakage Module[End] --}}
															...
															<div class="form-group">
                                                                <label class="col-sm-2 col-md-2 col-xs-5 control-label text-left">On-Demand Expired Date <span class="mandatory_field">*</span></label>
                                                                <div class="col-sm-6 col-md-6 col-xs-9">
                                                                      <div class="input-group">
                                ...
                                <div class="box-footer">
                                    <div class="col-xs-12 col-md-12 col-sm-12 text-left">
                                         <div class="col-xs-12 col-md-12 col-sm-12">
                                            ...
                                            <button type="submit" class="btn btn-primary waves-effect waves-light m-l-5"  onclick="fun_back_ganaral(1);" >Save And Back</button>
        ...
        @if($productID != 0 && $CategorytypeID != Config::get('config.packageCategorytypeID','12'))
