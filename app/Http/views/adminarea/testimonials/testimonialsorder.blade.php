...
<script>
	$(function() {
		  $('.submitbuttonSave').click(function()
		  {
			  ...
			  $.ajax({
				type: "POST",
				url: "{{ url('/') }}/adminarea/testimonials/saveorder",
				data: 'item='+h,
...
<form class="form-inline" role="form" name="frm_testimonials_addedit" method="post" action="{{ url('/') }}/adminarea/testimonials/saveorder">
...
<div class="right_side" role="main">
    <div class="center_container">
        <ul class="breadcrumb">
          ...
          <li class="active">Testimonials Order</li>
        </ul>
    </div>
    <div class="panel row">
        ...
        <div class="col-md-6" role="main">
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
				  <tr>
                    <th width="23%">Testimonials Title</th>
                  </tr>
                  <tr>
                      <td colspan="2">
                            <div id="sortable">
								...
								<?php $no_row=1; ?>
                                     @foreach($qGetAllTestimonials as $GetAlltestimonials)
                                      <div id="image_li_{{$GetAlltestimonials->testimonialsID}}" class="innerproduct_order_col ui-sortable-handle" >
                                         {{ $GetAlltestimonials->clientName}}
                                      </div>
                                    <?php $no_row++; ?>
									@endforeach
                                 @else
