...
//only this project - For redirect admin login to FE login[Start]
else
{
	return Redirect::away(url('/login-registration/dashboard'))->send();
}
//only this project - For redirect admin login to FE login[End]
        ...
        <div class="login_bg">
        	<div class="login-box-body">
                <div class="login_form">
                    ...
                    <div>
                      <form class="" name="frm_defaultForm" id="defaultForm" action="{{ url('/') }}/adminarea/login_process" method="post" autocomplete="off" > 
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder="Email" id="inputEmail" value="{{ $email }}" name="email" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="sign_btn">
                            ...
                            <a href="{{ url('/') }}/adminarea/forgotpassword" style="float:right; margin-top:15px;">Forgot Password ?</a>
                    </form>
                    </div>
