...
<script>
	$(function() {
		  $('.submitbuttonSave').click(function()
		  {
			  ...
			  $.ajax({
				type: "POST",
				url: "{{ url('/') }}/adminarea/news/saveorder",
				data: 'item='+h,
...
<form class="form-inline" role="form" name="frm_news_addedit" method="post" action="{{ url('/') }}/adminarea/news/saveorder">
                            ...
                            <div id="sortable">
								...
								<?php $no_row=1; ?>
                                     @foreach($qGetAllNews as $GetAllnews)
                                      <div id="image_li_{{$GetAllnews->newsID}}" class="innerproduct_order_col ui-sortable-handle" >
                                         {{ $GetAllnews->newsTitle}}
                                      </div>
                                    <?php $no_row++; ?>
									@endforeach
                                 @else
                  ...
                  <tr>
                    <td colspan="6">
                        <div class="col-sm-offset-2 col-sm-10">
                           ...
                           <button class="btn btn-default" type="button" onclick="fun_back_general_tab()">Back</button>
                        </div>
                    </td>
                  </tr>
              </table>
