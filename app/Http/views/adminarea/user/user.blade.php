...
<form role="form" name="frm_user_list" method="post" action="{{ url('/') }}/adminarea/user/index">
...
<input type="hidden" name="redirects_to" value="{{Request::fullUrl()}}" />
    ...
    <section class="content-header top_header_content">
        <div class="addproperty_button">
            <div class="col-sm-12 col-md-12 col-xs-12">
               <div class="row">
                    <div class="">
                        <a href="javascript:fun_edit(0);" class="add_edit_btn"><i class="fa fa-plus"></i>&nbsp; Add New User</a>
                        <a class="add_edit_btn" id="advance_search" href="javascript:funToggleSearch('User');"><i class="fa fa-search"></i>&nbsp; Search</a>
	...
	<section class="content-header top_header_content" id="searchSectionUser" @if(Session::get('searchSectionUser')!= 1) style=" display:none;" @endif> 
                  ...
                  <table id="example" class="table-bordered table-striped table-hover table">
                        <thead>
                             ...
                             <th>Created Date
                                    <div class="pull-left">
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            <a href="javascript:;" onclick="fun_upDown('user.created_at','ASC');" class="asc_desc_icon" >
                                                <span class="glyphicon glyphicon-triangle-top" aria-hidden="true"></span>
                                            </a>
                                        </div>
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                ...
                                @if(isset($recordcount))<?php $no_row=1; ?>
                                    @foreach($qGetAllUser as $GetAllUser)
                                        <tr id="ID_{{ $GetAllUser->userID }}" @if($GetAllUser->userID==$userID) class="bg-warning" @endif>
                                            ...
                                            <td>
                                                <a href="javascript:fun_edit({{ $GetAllUser->userID }});" title="Edit" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                @if($GetAllUser->userID !=1)
                                                <a href="javascript:fun_single_delete({{ $GetAllUser->userID }});" title="Delete"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                @endif
                                            </td>
                                            ...
                                            <td><a href="" data-toggle="modal" data-target="#myModal_{{ $GetAllUser->userID }}" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
