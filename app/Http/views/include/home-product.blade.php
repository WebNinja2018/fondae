<script type="text/javascript">
	function funGetProduct(catgory)
	{
		...
		frmobj.action="{{ url('/') }}/home/"+catgory;
		document.getElementById('frm_product').submit();
	}
</script>
<form name="frm_product" method="post" id="frm_product" action="">
    <input type="hidden" name="category" id="category" value="" />
    <div class="section">
        <div class="search-input">
            <div class="container">
                <div class="search-input-wrapper text-center">
                    <button type="button" class=" btn btn-blue btn_upcoming" onClick="return funGetProduct('upcoming');"><span>Upcoming Conferences</span></button>
                    <button type="button" class=" btn btn-blue btn_upcoming" onClick="return funGetProduct('ondemand');"><span>On-Demand Conferences</span></button>
