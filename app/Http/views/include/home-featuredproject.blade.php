...
<div class="container">
    <div class="row">
        <div class="main text-center">
            <h3 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Staff Picks/Featured Projects</h3>
            <h4 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">Our Featured Projects</h4>
        </div>
                ...
                <div class="carousel featured_projects">
                    <ul>
                     @if($staffpicsProductRecordCount > 0)
                        @foreach($staffpicsProductResult as $resultProduct)
                                        ...
                                        <div class="help-info" style="padding: 0px">
                                            ...
                                            <div class="box-bottom">
                                                <div class="skillbar" data-percent="{{ $goalpr }}%">
                                                    ...
                                                    <div class="skill-bar-percent" style="left: {{ $goalpr}}%;color: goldenrod;">{{ number_format($data['goalper'],2) }}%</div>
                                                </div>
...
<div class="container" style="padding-left:32%">
    <div class="row">
        <div class="main text-center">
            <a class="fondae_btn hvr-shutter-out-horizontal" href="{{url('/')}}/explore">Explore</a>
        </div>
   </div>
</div>