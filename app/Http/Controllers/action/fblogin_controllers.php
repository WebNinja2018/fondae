...
//	//Check Captcha [END]
	...
	$CustomerData=$Customer->where($contactsData)->first();
...
//	$_POST['formID']=\Config::get('config.customerFormID');
	...
	$customerID=Customer::where('customerID', $customerID)->update($customerData);    /*Login Update*/
...
//	//For Admin Login[End]
	...
	//return Redirect::away(url('/'))->with(array('flash_message' => 'Guest Login Successfully.'))->send();
?>