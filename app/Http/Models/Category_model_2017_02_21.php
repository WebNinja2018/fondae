...
class Category_model extends Model
{
    ...
    protected $fillable = array('categoryname','parentCategoryID','categorytypeID','displayOrder','isActive','isFeatured','pageTitle','pageMetaKeyword','pageDescription','content','imagename','createdby','urlName');
