...
class Product extends Model
{
	...
	protected $fillable = array('categoryID','productName','availabilityStatus','prodcutImage','altimage','city','price', 'shortDescription', 'longDescription', 'producttype', 'keywordDescription', 'itemnumber', 'isActive', 'isDraft', 'isFeatured', 'displayOrder', 'pageTitle','productDate','productExpiredDate','productStartTime','productEndTime','createdby', 'metaKeyword' , 'metaDescription', 'url_title', 'createdBy');
	...
	public function getAllProduct($srach_categorytypeID)
	{
		...
		$getAllProduct=$query->paginate(10);  //With Pagination
